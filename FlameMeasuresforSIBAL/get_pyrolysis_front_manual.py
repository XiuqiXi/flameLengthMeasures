...
number_write = open("burnout.txt","w")

for k in range(0, len(list_jpg)-1, 33):
    ...
    str_pyrolysis_front_each = str(pyrolysis_front_each)
    number_write.write(str_pyrolysis_front_each+"\n")
